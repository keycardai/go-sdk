...
- fix(oauth): reject control characters in access tokens (#52)
...
- fix(mcp): stop rewriting the proxied authorization_endpoint (SDK-3) (#49)
- AuthMetadataHandler's AS-metadata proxy appended resource=<origin> to the
upstream authorization_endpoint, a shim for MCP clients on the 2025-03-26
