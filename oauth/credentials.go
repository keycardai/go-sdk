...
type ApplicationCredential interface {
	...
	PrepareTokenExchangeRequest(ctx context.Context, subjectToken, resource string, opts *PrepareOptions) (*TokenExchangeRequest, error)
}
...
func (c *ClientSecretCredential) PrepareTokenExchangeRequest(_ context.Context, subjectToken, resource string, _ *PrepareOptions) (*TokenExchangeRequest, error) {
...
func (w *WebIdentityCredential) PrepareTokenExchangeRequest(ctx context.Context, subjectToken, resource string, opts *PrepareOptions) (*TokenExchangeRequest, error) {
...
// ClientID returns the registered OAuth client id set via WithClientID, or an
// empty string when none was configured.
func (w *WebIdentityCredential) ClientID() string {
	return w.clientID
}
